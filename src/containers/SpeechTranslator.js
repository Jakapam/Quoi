        ...
        <div
          ...
          <h2>
            {!this.state.listening ? (
              ...
              <span>
                Listening
                <span className="animated fadeIn quarterSecondDelay infinite">
                  .
                </span>
                <span className="animated fadeIn halfSecondDelay infinite">
                  .
                </span>
                <span className="animated fadeIn threeQuarterSecondDelay infinite">
                  .
                </span>
              </span>
            )}
          ...
          />
          <p style={{ fontWeight: "normal" }}>What I think you said:</p>{" "}
          <p style={{ fontSize: 20 }}>&nbsp;{this.state.currentText}&nbsp;</p>
          <p style={{ fontWeight: "normal" }}>Translation:</p>{" "}
          <p style={{ fontSize: 20 }}>
